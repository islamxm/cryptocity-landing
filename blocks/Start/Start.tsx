                    ...
                    <div className={styles.chart}>
                        <div className={styles.el}>
                            ...
                            <svg width="371" height="371" viewBox="0 0 371 371" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id='1' filter="url(#filter0_d_26_1608)">
                                <path
                                ...
                                <path d="M121.597 313.995C86.7099 299.181 58.0533 272.707 40.528 239.1C23.0028 205.493 17.6977 166.842 25.52 129.756L57.516 136.505C51.2581 166.174 55.5022 197.095 69.5224 223.98C83.5426 250.865 106.468 272.045 134.378 283.896L121.597 313.995Z" fill="url(#paint2_linear_26_1608)"/>
                                </g>
                                <g id='4' filter="url(#filter3_d_26_1608)">
                                <path d="M25.2031 131.295C32.1061 96.9364 49.8661 65.705 75.8648 42.2054C101.864 18.7058 134.725 4.18173 169.604 0.774553L172.783 33.3196C144.88 36.0454 118.591 47.6646 97.7919 66.4643C76.9929 85.264 62.7848 110.249 57.2625 137.736L25.2031 131.295Z" fill="url(#paint3_linear_26_1608)"/>
                                </g>
